  ...
  return (
    <div className="bg-gradient-to-r from-base-200 to-base-300 min-h-screen p-8">
      ...
      <div className="bg-base-100 shadow-2xl rounded-lg p-8 mb-8 text-white">
        ...
        <p className="text-center text-lg font-medium">Full-Stack Web Developer</p>
        <p className="text-center mt-4">
          Email: <a href="mailto:davidbalishyan@proton.me" className="link link-hover">davidbalishyan@proton.me</a>
          <br />
          Email: <a href="mailto:davidbalishya12n@gmail.com" className="link link-hover">davidbalishya12n@gmail.com</a>
          <br />
          Email: <a href="mailto:davidbalishyan.work@gmail.com" className="link link-hover">davidbalishyan.work@gmail.com</a>
        </p>
        <p className="text-center">
          Phone: <a href="tel:+37477126556" className="link link-hover">+374 77-12-65-56</a>
        </p>
        <div className="flex justify-center mt-6 gap-4">
          <a href="https://github.com/DavidBalishyan" className="btn btn-outline btn-accent">GitHub</a>
          <a href="https://x.com" className="btn btn-outline btn-info">X(twitter)</a>
        </div>
      </div>
      ...
      <div className="bg-base-100 shadow-2xl rounded-lg p-8 mb-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-secondary">ABC Company | Jan 2022 - Present</p>
          <ul className="list-disc ml-6 mt-4 text-base">
            <li>Developed responsive web applications using React and TailwindCSS.</li>
        ...
        <div>
          ...
          <p className="text-sm text-secondary">XYZ Company | Jun 2021 - Dec 2021</p>
          <ul className="list-disc ml-6 mt-4 text-base">
            <li>Assisted in building e-commerce platforms using ReactJS.</li>
            <li>Fixed bugs and implemented new features based on client requirements.</li>
          </ul>
        </div>
      </div>
      ...
      <div className="bg-base-100 shadow-2xl rounded-lg p-8 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-secondary">University of Technology | 2018 - 2022</p>
          <p className="mt-4 text-base">Graduated with honors, specializing in web development and software engineering.</p>
        </div>
      </div>
      ...
      <div className="bg-base-100 shadow-2xl rounded-lg p-8">
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <span className="badge badge-primary p-4 text-lg">Responsive Design</span>
          <span className="badge badge-primary p-4 text-lg">Problem Solving</span>
          <span className="badge badge-primary p-4 text-lg">typescript</span>
